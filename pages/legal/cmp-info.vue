<template>
  <div class="markdown-body">
    ...
    <p>
      This page was created for transparency for how the rewards program works on Bedrinth. Feel
      free to join our Discord or email
      <a href="mailto:wyd1542536763@gmail.com">support@bedrinth.com</a> if you have any questions!
    </p>
    <p>
      This document is provided for informational purposes only and does not constitute a legal
      agreement. Bedrinth makes no representations or warranties as to the accuracy, completeness,
    ...
    <p>In this scenario, the earnings for each creator and Bedrinth would be as follows:</p>
    <ul>
      <li>Bedrinth: $10 (10% of $100, the site's earnings for the day)</li>
    ...
    <p>
      ...
      downloads are counted equally. In each category, Bedrinth actively removes botted downloads
      and page views at our own discretion. If users are caught botting, they will be permanently
      banned from using Bedrinth's services.
    </p>
    <p>
    ...
    <p>
      No. All creators who upload to Bedrinth automatically will receive funds as according to the
    ...
    <p>
      Right now, you can use PayPal or Venmo to withdraw money from your Bedrinth account. We are
      working on more methods to withdraw money from your account. There are fees to withdraw money
      from your Bedrinth account—see the revenue page in your dashboard for more information.
    </p>
    <h3>Bedrinth used to give 100% of project page revenue to creators. What changed?</h3>
    <p>
...
<script setup>
const description =
  'Information about the Rewards Program of Bedrinth, an open source modding platform focused on Minecraft.'

useSeoMeta({
  title: 'Rewards Program Information - Bedrinth',
  description,
