<template>
  <div class="markdown-body">
    ...
    <p>
      ...
      the Bedrinth Rewards Program (the "Rewards Program").
    </p>
    <p>
      The Rewards Program provides developers and content creators an opportunity to monetize the
      projects ("Projects") that they upload to the Bedrinth website.
    </p>
    <p>
    ...
    <p>
      ...
      attributable to ad impressions displayed on bedrinth.com and the Bedrinth App excluding
...
<script setup>
const description =
  'The Rewards Program Terms of Bedrinth, an open source modding platform focused on Minecraft.'

useSeoMeta({
  title: 'Rewards Program Terms - Bedrinth',
  description,
