  ...
  <div>
    <div class="landing-hero">
      ...
      <h1 class="main-header">
        The place for Minecraft:BE
        <br />
        <span>
          <strong class="main-header-strong">plugins</strong>
        </span>
      </h1>
      <h2>
      ...
      <div class="button-group">
        <nuxt-link to="/mods" class="iconified-button brand-button"> Discover plugins</nuxt-link>
        <nuxt-link
          v-if="!auth.user"
          to="/auth/sign-up"
      ...
      <div class="users-section">
        <div class="section-header">
          ...
          <p class="section-description">
            From mini-game to more armors, you can be sure to find content to bring your
        ...
        <div class="feature-blob">
          <div class="blob-text">
            ...
            <p>
              Bedrinth's lightning-fast search and powerful filters let you find what you want as
              you type.
            </p>
          </div>
    ...
    <div class="creator-section">
      ...
      <div class="features">
        ...
        <div class="feature gradient-border">
          ...
          <p>
            Get the best modding experience possible with constant updates from the Bedrinth team
          </p>
        </div>
      </div>
      <Card style="width: 60%; margin-left: auto; margin-right: auto">
        <div style="color: #d52c2c; margin-bottom: 10px"><strong>Notice:</strong></div>
        <strong>"Bedrinth" is not an official affiliate of "Modrinth". It was mainly created as a
          plugin hub for "PowerNukkitX"!</strong>
      </Card>
    </div>
  </div>
</template>
...
import BedrinthIcon from '~/assets/images/logo.svg'
