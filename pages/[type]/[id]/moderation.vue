  ...
  <div>
    <section class="universal-card">
      ...
      <div v-else-if="isUnderReview(project)">
        <p>
          Bedrinth's team of content moderators work hard to review all submitted projects.
          ...
          Bedrinth's moderators will leave a message below if they have any questions or concerns
          for you.
        </p>
        <p>
          ...
          <a
            class="text-link"
            href="https://support.bedrinth.com/en/articles/8793355-bedrinth-project-review-times"
            target="_blank"
          >
      ...
      <template v-else-if="isRejected(project)">
        <p>
          Your project does not currently meet Bedrinth's
    ...
    <section id="messages" class="universal-card">
      <h2>Messages</h2>
      <p>
        This is a private conversation thread with the Bedrinth moderators. They may message you
        ...
        <a href="mailto:wyd1542536763@gmail.com">Bedrinth support</a>.
      </p>
      <ConversationThread
        v-if="thread"
        :thread="thread"
...
<script setup>
import { Badge, CheckIcon, ExitIcon, IssuesIcon } from 'omorphia'
