...
const messages = defineMessages({
  ...
  sessionsDescription: {
    ...
    defaultMessage:
      'Here are all the devices that are currently logged in with your Bedrinth account. You can log out of each one individually.\n\nIf you see an entry you don\'t recognize, log out of that device and change your Bedrinth account password immediately.',
  },
...
useHead({
  title: () => `${formatMessage(commonSettingsMessages.sessions)} - Bedrinth`
})
