...
const nags = computed(() => [
  ...
  },
  {
    ...
    id: 'add-links',
    description:
      'Add any relevant links targeted outside of Bedrinth, such as sources, issues, or a Discord invite.',
    status: 'suggestion',
    link: {
      path: 'settings/links',
  ...
  },
  {
    ...
    description: `Your project has been ${props.project.status} by
            Bedrinth's staff. In most cases, you can resubmit for review after
